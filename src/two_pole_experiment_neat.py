#
# This file provides the source code of the Two Pole-Balancing experiment using the NEAT-Python library
#
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="The Two Pole-Balancing experiment runner (NEAT-Python).")
    ...
    config_path = os.path.join(local_dir, 'pole/two_pole_markov_config.ini')

    # The directory to store experiment outputs
    out_dir = os.path.join(local_dir, '../out/two_poles/neat')
