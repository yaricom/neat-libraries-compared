#
# This file provides the source code of the Single Pole-Balancing experiment using on MultiNEAT-Python library
#
# 
#  The Single Pole-Balancing experiment adapted from original MultiNEAT source code available at: 
#  https://github.com/peter-ch/MultiNEAT/blob/master/examples/gym/pole_balancing.py
# 
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="The Single Pole-Balancing experiment runner (MultiNEAT-Python).")
